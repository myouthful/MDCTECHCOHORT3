      ...
      <div className="md:w-1/2 flex flex-col justify-center px-10 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex items-center mb-6 space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#1D1B4C]">Skill2Earn</h1>
              <p className="text-sm text-gray-500 -mt-1">Where skills meet opportunity</p>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-[#1D1B4C] mb-6">Create an Account</h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-3 border rounded-md appearance-none focus:ring-2 focus:ring-purple-400"
              >
            ...
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm text-gray-600">
                ...
                <a href="#" className="text-[#1D1B4C] font-medium hover:underline">Terms of Service</a>,{' '}
                <a href="#" className="text-[#1D1B4C] font-medium hover:underline">User Agreement</a>, and{' '}
                <a href="#" className="text-[#1D1B4C] font-medium hover:underline">Privacy Policy</a>.
              </p>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#1D1B4C] text-white py-3 rounded-md hover:bg-[#2b2a66] transition"
            >
              Create Account
            </button>
          </form>
          ...
          <p className="text-sm text-center mt-6">
            ...
            <a href="/signin" className="text-[#1D1B4C] font-medium hover:underline">Sign In</a>
          </p>
        </div>
      </div>
