...
<ul className="flex  flex-1 justify-center list-none gap-[18px]">
  <li className="w-fit h-[18.3px]  font-inter">Home</li>
  <li className="w-fit h-[18.3px] font-inter">About Us</li>
  <li className="w-[47.19px] h-[18.3px] font-inter">FAQs</li>
  <li className="w-[92.45px] h-[24px] font-inter">Contact Us</li>
</ul>
